...
<body>
    <section class="main">
        ...
        <div class="timing">
            ...
            </div><span><img src="./assets/img/arrow-right-long-solid.svg" alt="arrow" width="40px" height="20px"></span>
            <!-- office contact  -->
            <div class="office-number">
                <h3>Do you need to contact us? <br>We are here to listen</h3>
                <a href="#"><p><strong> Contact Us </strong> During Business Hours.</p></a>
            </div>
        </div>
        <!-- arrow -->
        <a href="#services">
    ...
    <!-- <section class="social-media">
        ...
        <!-- <ul class="media">
            <li class="instagram">
                <a href="#"><img src="./assets/img/instagram-brands.svg" alt="instagram" height="100px" width="100px"></a>
            </li>
            <li class="tiktok">
            ...
            <li class="twitter">
                <a href="#" ><img src="./assets/img/twitter-square-brands.svg" alt="twitter" height="100px" width="100px"></a>
            </li>
        </ul>
    </section> -->
    <!-- footer -------------->
